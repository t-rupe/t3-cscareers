      ...
      typography: ( theme: any ) => ({
        lightgray: {
          css: {
            ...
            '--tw-prose-invert-headings': theme('colors.gray[700]'),
            '--tw-prose-invert-lead': theme('colors.gray[800]'),
            '--tw-prose-invert-links': theme('colors.gray[700]'),
            '--tw-prose-invert-bold': theme('colors.gray[700]'),
            ...
            '--tw-prose-invert-code': theme('colors.gray[700]'),
