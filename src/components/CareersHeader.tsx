    ...
    <div className="bg-gray-900 py-1 sm:py-1">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h1 className="text-base font-semibold leading-7 text-indigo-400">Explore the Possibilities</h1>
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Top Careers in Computer Science</h2>
